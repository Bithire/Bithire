...
unsigned int nStakeMinAge = 2 * 60 * 60; // 2 hour
unsigned int nStakeMaxAge = 40 * 24 * 60 * 60; // 40 days
...
const string strMessageMagic = "Bithire Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Bithire", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CNN US sending top-line F-22 jets to Europe";
        CTransaction txNew;
        txNew.nTime = 1440941215;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1440941215;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 688885 : 0;

         //// debug print
        assert(block.hashMerkleRoot == uint256("0x0ec048a54547c65486bcfc153e77911d34df100fc596049d15362cdc0a77d228"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0x07, 0xa1, 0x11, 0xb3 };
