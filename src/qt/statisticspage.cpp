...
void StatisticsPage::updateStatistics()
{
    ...
    uint64_t nMinWeight = 0, nWeight = 0;
    ...
    {
        ui->volumeBox->setText("<b><font color=\"green\">" + qVolume + " HIRE" + "</font></b>");
    } else if(volume < volumePrevious) {
        ui->volumeBox->setText("<b><font color=\"red\">" + qVolume + " HIRE" + "</font></b>");
    } else {
        ui->volumeBox->setText(qVolume + " HIRE");
    }
